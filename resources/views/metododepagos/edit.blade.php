    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('metododepago-actualizar', $metododepago->id) }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" placeholder="Ingrese el nombre del metodo de pago" name="nombre" class="form-control @error('nombre') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('nombre') == "" ? $metododepago->nombre : old('nombre') }}">
              @error('nombre')
