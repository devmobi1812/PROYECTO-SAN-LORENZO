    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('descuento-actualizar', $descuento->id) }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" placeholder="Ingrese un nombre" name="nombre" class="form-control @error('nombre') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('nombre') == "" ? $descuento->nombre : old('nombre') }}">
              @error('nombre')
