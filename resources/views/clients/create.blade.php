    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('cliente-guardar') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Ingrese información de contacto, puede ser telefono o mail" name="contacto" class="form-control @error('contacto') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('contacto') }}">
                @error('contacto')
                <small class="text-danger"> {{ '*'.$message}}</small>
            @enderror
            </div>
