...
@section('contenido')
    <div class="container-fluid px-4">
        ...
        <div>
            ...
            <p>Los alumnos que participaron en el desarrollo de la primera versión de esta plataforma no son responsables de la pérdida de datos o de la manipulación que se realice posterior a la versión 1.87.107. La responsabilidad de la integridad y el uso de los datos recae exclusivamente en los administradores autorizados del Club San Lorenzo Rauch.</p>
