    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('servicio-actualizar', $servicio->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Ingrese el nombre del servicio" name="nombre" class="form-control @error('nombre') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('nombre')=="" ? $servicio->nombre : old('nombre') }}">
                @error('nombre')
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Ingrese solo numeros" name="precio" class="form-control @error('precio') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('precio')=="" ? $servicio->precio : old('precio') }}">
                @error('contacto')
                <small class="text-danger"> {{ '*'.$message}}</small>
            @enderror
            </div>
