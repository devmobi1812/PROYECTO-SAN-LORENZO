    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('abono-actualizar', $abono->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" placeholder="Ingrese solo numeros" name="monto_pagado" class="form-control @error('monto_pagado') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('monto_pagado')=="" ? $abono->monto_pagado : old('monto_pagado') }}">
                @error('monto_pagado')
