    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('abono-guardar') }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" placeholder="Monto abonado" name="monto_pagado" class="form-control @error('monto_pagado') is-invalid @enderror" aria-describedby="emailHelp" value="{{ old('monto_pagado') }}">
                @error('contacto')
